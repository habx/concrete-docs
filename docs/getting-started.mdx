...
You can now use safely **Concrete**
...
import { Button, notify, Provider } from '@habx/ui-core';

<Provider>
  <Button onClick={() => notify("I can be display only with provider")}>Click Me!</Button>
</Provider>
